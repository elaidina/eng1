document.addEventListener('DOMContentLoaded', () => {
  ...
  const cardArray = [
    ...
    {
      name: '9',
      img: 'Ten vysoký kluk je můj kamarád.'
    },
    {
      name: '10',
    ...
    {
      name: '11',
      img: 'Miško, půjč mi prosím tvoje pero.'
    },
    {
      name: '12',
...
audio1.play();
    ...
    if  (cardsWon.length === cardArray.length/2) {
      resultDisplay.innerHTML = ' <h1>Congratulations! You found them all!</h1><h2>Level 2 completed!</h2><a href="/eng1/level3.html"> Continue to Level 3</a>'
